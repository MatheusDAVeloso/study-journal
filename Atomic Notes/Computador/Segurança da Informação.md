...
### 1. Técnica de segurança de [[Host]]
O [[TPM]] por ser um [[Root of trust]], garante que se a integridade de um sistema de hardware de computador estiver seguro, tem um [[Bitlocker]] seguro.

### 2. Proteção contra cheat em jogos
